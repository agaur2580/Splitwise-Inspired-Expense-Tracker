...
export const getAllContacts = query({
  handler: async (ctx) => {
    ...
    const expensesYouPaid = await ctx.db.query("expenses").withIndex("by_user_and_group", (q) =>
      ...
      .collect()).filter((e)=>e.paidByUserId!==currentUser._id&& e.splits.some(s=>
      ...
      personalExpenses.forEach((exp)=>{
        ...
        //ADD each user in the splits that is not the current user
  ...
  // Now sort results alphabetically by name
