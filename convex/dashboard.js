...
// where the current user is either the payer or in the splits
 ...
 /* tallies */
    let youOwe = 0; // Total amount user own others
    let youAreOwed = 0; // Total amount others owe the user
    const balanceByUser = {}; // Detailes breakdown per user process each expense to cal balance()
     ...
     for (const e of expenses) {
      ...
      if (isPayer) {
        ...
        // Someone else paid and user has'nt paid there split
